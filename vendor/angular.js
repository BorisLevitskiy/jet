    ...
    while (i--) {
      ...
      if (!eventFns) {
        ...
        if (type === 'mouseenter' || type === 'mouseleave') {
          ...
          // http://www.quirksmode.org/vendor/events_mouse.html#link8
 ...
 *
 <example module="compileExample">
   ...
   <file name="protractor.vendor" type="protractor">
...
// Commented out due to flakes. See https://github.com/angular/angular.vendor/issues/9185
...
function $RootScopeProvider(){
  ...
  this.$get = ['$injector', '$exceptionHandler', '$parse', '$browser',
     ...
     * ```html
     * <file src="./test/ng/rootScopeSpec.vendor" tag="docs1" />
     * ```
     *
     * # Inheritance
    ...
    Scope.prototype = {
      ...
      $destroy: function() {
        ...
        // - https://github.com/angular/angular.vendor/issues/6794#issuecomment-38648909
        // - https://github.com/angular/angular.vendor/issues/1313#issuecomment-10378451
...
// Copied from:
// http://docs.closure-library.googlecode.com/git/closure_goog_string_string.vendor.source.html#line962
 ...
 *      recommended, e.g. in issue [#4006](https://github.com/angular/angular.vendor/issues/4006)),
 ...
 *
 * <example module="mySceApp" deps="angular-sanitize.vendor">
 * <file name="index.html">
...
function $SceProvider() {
  ...
  this.$get = ['$parse', '$sniffer', '$sceDelegate', function(
     ...
     *
     * @param {string} type The kind of context in which this value is safe for use.  e.g. url,
     *   resource_url, html, vendor and css.
     * @param {*} value The value that that should be considered trusted/safe.
     * @returns {*} A value that can be used to stand in for the provided `value` in places
     * where Angular expects a $sce.trustAs() return value.
     */
...
function $SnifferProvider() {
  this.$get = ['$window', '$document', function($window, $document) {
    ...
    return {
      ...
      // https://github.com/angular/angular.vendor/issues/904
 ...
 *   https://github.com/angular/angular.vendor/pull/2902
 ...
 *
 * @example
    <example deps="angular-animate.vendor" animations="true" fixBase="true" module="formExample">
      <file name="index.html">
       <script>
 ...
 *
 * <example name="NgModelController" module="customControl" deps="angular-sanitize.vendor">
    <file name="style.css">
      [contenteditable] {
 ...
 *
 *  - [https://github.com/angular/angular.vendor/wiki/Understanding-Scopes]
 *
 ...
 *
 * @example
 * <example deps="angular-animate.vendor" animations="true" fixBase="true" module="inputExample">
     <file name="index.html">
       <script>
        angular.module('inputExample', [])
          .controller('ExampleController', ['$scope', function($scope) {
 ...
 * @example
   ...
   <example module="bindHtmlExample" deps="angular-sanitize.vendor">
     <file name="index.html">
       <div ng-controller="ExampleController">
 ...
 * @example Example that demonstrates basic bindings via ngClass directive.
   ...
   <example module="ngAnimate" deps="angular-animate.vendor" animations="true">
     <file name="index.html">
 ...
 * of the browser view.
 *
 * `ngCloak` works in cooperation with the following css rule embedded within `angular.vendor` and
 * `angular.min.vendor`.
 ...
 *
 * For the best result, the `angular.vendor` script must be loaded in the head section of the html
 ...
 * directive on the root element of the application or on the `angular.vendor` script tag, whichever
 ...
 * [prototypal inheritance](https://github.com/angular/angular.vendor/wiki/The-Nuances-of-Scope-Prototypal-Inheritance).
 ...
 *
 * @example
  <example module="includeExample" deps="angular-animate.vendor" animations="true">
    <file name="index.html">
     <div ng-controller="ExampleController">
 ...
 * These rules are bundled with angular.vendor, but can be overridden
 ...
 *
 * @example
  <example module="switchExample" deps="angular-animate.vendor" animations="true">
    <file name="index.html">
      <div ng-controller="ExampleController">
